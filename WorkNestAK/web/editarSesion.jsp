...
<div class="contenedor">
    ...
    <div class="derecha">
        <div class="form-container">
            ...
            <%
            sesion s = (sesion) request.getAttribute("sesion");
        %>


            <% if (s == null) { %>
            <form method="get" action="SesionServlet">
                <label>Ingrese el nombre de la sesion:</label>
                <input type="text" name="nombre_sesion" required>
                <button type="submit" name="accion" value="buscar">Buscar</button>
            </form>
            <% } else { %>
            <form method="post" action="SesionServlet">
                <input type="hidden" name="accion" value="actualizar">
                <input type="hidden" name="id_sesion" value="<%= s.getId_sesion() %>">
                <input type="text" name="nombre_sesion" value="<%= s.getNombre_sesion() %>" readonly>
                <input type="text" name="descripcions" value="<%= s.getDescripcions() %>" required>
                <input type="date" name="fecha_inicio" value="<%= s.getFecha_inicio() %>" required>
                <input type="date" name="fecha_fin" value="<%= s.getFecha_fin() %>" required>
                <input type="text" name="lugar" value="<%= s.getLugar() %>" required>
