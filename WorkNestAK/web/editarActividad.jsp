...
<div class="contenedor">
    ...
    <div class="derecha">
        ...
        %>
            ...
            <% if (a == null) { %>
            <form method="get" action="ActividadServlet">
                <label>Ingrese el nombre de la actividad:</label>
            ...
            <form method="post" action="ActividadServlet">
                ...
                <input type="hidden" name="id_actividad" value="<%= a.getId_actividad() %>">
                <input type="text" name="nombre_actividad" value="<%= a.getNombre_actividad() %>" readonly>
                <input type="text" name="descripciona" value="<%= a.getDescripciona() %>" required>
                <input type="text" name="enlace" value="<%= a.getEnlace() %>" required>
