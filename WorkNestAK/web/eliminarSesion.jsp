...
<div class="contenedor">
    ...
    <div class="derecha">
        ...
        <form action="SesionServlet" method="get">
                    ...
                    <div class="info"><strong>Nombre:</strong> <%= s.getNombre_sesion() %> %></div>

                    <form action="SesionServlet" method="post" onsubmit="return confirm('¿Seguro que deseas eliminar esta sesion?');">
                        <input type="hidden" name="accion" value="eliminar">
                        <input type="hidden" name="nombre_sesion" value="<%= s.getNombre_sesion() %>">
                        <button type="submit" class="btn">Confirmar</button>
                    </form>


                    <form action="eliminarSesion.jsp" method="get">
